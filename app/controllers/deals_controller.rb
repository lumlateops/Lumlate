class DealsController < ApplicationController
  ...
  def index
    ...
    @deal_emails = current_user.deal_emails_by_expiry_date.paginate(:page => params[:page], :per_page => 10)
  ...
  def deal_emails_by_max_or_min_value
    ...
    if params[:deals_by_value_filter] == 'max'
      @deal_emails = current_user.deal_emails_by_max_value.paginate(:page => params[:page], :per_page => 10)
    else
      @deal_emails = current_user.deal_emails_by_min_value.paginate(:page => params[:page], :per_page => 10)
    end
  ...
  def deal_emails_by_companies
    ...
    @deal_emails = current_user.deal_emails_by_companies(params[:deals_by_companies_filter]).paginate(:page => params[:page], :per_page => 10)
  ...
  def deal_emails_with_tags
    ...
    @deal_emails = current_user.deal_emails_tagged_with(params[:deals_with_tags_filter]).paginate(:page => params[:page], :per_page => 10)
  ...
  def deal_emails_by_rating
    ...
    @deal_emails = current_user.deal_emails_by_rating.paginate(:page => params[:page], :per_page => 10)
